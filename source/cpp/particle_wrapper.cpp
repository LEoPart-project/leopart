...
PYBIND11_MODULE(particle_wrapper, m)
{
  ...
  py::class_<dolfin::particles>(m, "particles")
    .def(py::init<Eigen::Ref<const Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>,
  ...
  py::class_<dolfin::advect_particles>(m, "advect_particles")
    .def(py::init<dolfin::particles&, dolfin::FunctionSpace&, dolfin::Function&, const std::string, const std::string>())
    .def(py::init<dolfin::particles&, dolfin::FunctionSpace&, dolfin::Function&, const std::string,
  ...
  py::class_<dolfin::PDEStaticCondensation>(m, "PDEStaticCondensation")
    ...
    py::class_<dolfin::AddDelete>(m, "AddDelete")
     ...
     .def(py::init<dolfin::particles&, std::size_t, std::size_t, std::vector<std::shared_ptr<const dolfin::Function>>>())
     .def(py::init<dolfin::particles&, std::size_t, std::size_t, std::vector<std::shared_ptr<const dolfin::Function>>, std::vector<std::size_t>, std::vector<double>>())
