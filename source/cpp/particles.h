...
public:
  ...
  // Add new particles. Input array is passed by value,
  // since an internal copy is needed anyway.
  void AddParticles(Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic,Eigen::RowMajor>p_array);
