...
while step < num_steps:
    ...
    P1 = assemble(Uh.sub(1) * dsp(1)) / assemble(Constant(1.) * dsp(1))
    P2 = assemble(Uh.sub(1) * dsp(2)) / assemble(Constant(1.) * dsp(2))
    P3 = assemble(Uh.sub(1) * dsp(3)) / assemble(Constant(1.) * dsp(3))
    P4 = assemble(Uh.sub(1) * dsp(4)) / assemble(Constant(1.) * dsp(4))

    P1_bar = assemble(Uhbar.sub(1) * dsp(1)) / assemble(Constant(1.) * dsp(1))
    P2_bar = assemble(Uhbar.sub(1) * dsp(2)) / assemble(Constant(1.) * dsp(2))
    P3_bar = assemble(Uhbar.sub(1) * dsp(3)) / assemble(Constant(1.) * dsp(3))
    P4_bar = assemble(Uhbar.sub(1) * dsp(4)) / assemble(Constant(1.) * dsp(4))
