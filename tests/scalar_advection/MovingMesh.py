...
s = assign_particle_values(x, CosineHill(radius=0.25, center=[0.25, 0.5], amplitude=1.0, degree=1))
...
forms_pde = FormsPDE.forms_theta_linear(
    phih0, uadvect, dt, Constant(1.0), zeta=Constant(0.0), h=Constant(0.0)
)
